      ...
      <AnimatePresence>
        {tooltip && (
          <motion.div
            ...
            className="hidden sm:flex items-center gap-2 bg-white rounded-2xl px-4 py-3 shadow-xl shadow-black/10 border border-cream-200"
          >
            <span className="text-charcoal-700 text-sm font-medium whitespace-nowrap">
              Ada yang bisa dibantu? 😊
            </span>
            <button onClick={() => setTooltip(false)} className="text-charcoal-400 hover:text-charcoal-600 transition-colors">
              <X size={14} />
            </button>
          </motion.div>
        )}
