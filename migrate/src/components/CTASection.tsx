...
export default function CTASection() {
  ...
  return (
    <section className="py-20 sm:py-28 bg-white relative overflow-hidden" ref={ref}>
      <div className="absolute inset-0 bg-gradient-to-br from-terracotta-500 via-terracotta-600 to-forest-700" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-white mb-6 leading-tight">
              Siap Memanjakan Tamu di Acara Anda?
            </h2>
            <p className="text-white/80 text-base sm:text-lg leading-relaxed mb-8">
              Konsultasikan kebutuhan catering atau pesan frozen food favorit Anda sekarang. Tim kami siap membantu mewujudkan hidangan sempurna untuk setiap momen.
            </p>
          ...
          >
            {[
              ...
              <a
                key={item.label}
                href={item.href}
                className="flex items-start gap-4 p-5 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/15 hover:bg-white/15 transition-all duration-300 group"
              >
                ...
                <div>
                  <div className="text-white/60 text-xs font-medium uppercase tracking-wider mb-1">{item.label}</div>
